...
const btnPulsado = (e, pos) => {
    turno ++;
    const div = e.target;
    const characters = turno % 2 ? 'Charizard' : 'Blastoise'; // Asegúrate de tener los nombres correctos
    const imagen = `public/img/${characters}.JPG`; // Asegúrate de tener la ruta correcta
...
const endgame = (results) => {
    ...
    containerButton.style.display = 'none';  // Cambiar CanvasGradient.style.display por containerButton.style.display
