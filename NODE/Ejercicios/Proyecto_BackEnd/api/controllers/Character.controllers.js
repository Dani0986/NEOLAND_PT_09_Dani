...
//! traer funcion de boorar imagenes por si el usuario tiene un error al subir la iagen que se borre

const { deleteImgCloudinary } = require("../../middleware/files.middleware");
const enumOK = require("../../utils/enumOk");

//! nos trameos el modelo
...
// guardar url de la imagen que se sube a cludinary
 ...
 try {
    // actualizar indexes
    //los indexes se formann cuando la clave es unica
    // es importante por si es modificadoo posteriormente a la creacion del controlador
   ...
   if (saveCharacter) {
    ...
    return res
      .status(404) //  indica que la página solicitada por el usuario no se encontró en el servidor
